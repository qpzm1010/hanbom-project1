    ...
    <section class="content">
        ...
        <div class="card-grid">
            ...
            <div class="card">
                ...
                <p>회사명: (주)신통네트워크ㅣ전화번호: 070-7860-7482ㅣFAX: 070-7862-6710<br>
                주소: 경기도 수원시 권선구 호매실로ㅣ우편번호: 12345<br>
                대표자명: 남신통ㅣ담당부장: 정보통<br>
                주요생산품: 모바일 기기 및 애플리케이션<br>
                종업원수: 30명
                </p>
                <h3 style="text-align: left;">2. 채용현황</h3>
                <p>근무부서 모집직종:<br>
                H/W(모바일 기기) 관련, S/W(애플리케이션) 관련,<br>
                빅데이터(데이터베이스) 관련, 네트워크(유선·무선) 관련<br>
                자격조건: 특성화고(IT관련 전공) 졸업(예정) 및 관련 자격증 보유자 우대,<br>
                관련 직종과 관련된 다양한 활동 유경험자,<br>
                해외여행에 결격사유 없는 자<br>
                채용인원: 2명
                </p>
                <h3 style="text-align: left;">3. 급여</h3>
                <p>근무시간: 11:00 ~ 16:00(필수), 8시간 근무 적용하여 자율출퇴근 가능<br>
                급여형태: 주 5일 / 주당 40시간 근무<br>
                급여: 연봉 2,400만원ㅣ상여금: 1년 근속 400%<br>
                기타: 도시지원비(10만원), 중식 제공
                </p>
                <h3 style="text-align: left;">4. 지원전형</h3>
                <p>서류전형 마감: 2024.10.25.(금) 17:00ㅣ입사지원서, 생활기록부<br>
                서류전형 합격자 발표: 2024.10.28.(월) 13:00ㅣGOE메신저(담임)으로 통보<br>
                1차 실무자면접: 2024.10.29.(화) 17:00ㅣ각 면접장(취업정보센터 추후 공지)<br>
                1차 합격자 발표: 2024.11.01.(금) 13:00ㅣGOE메신저(담임)으로 통보<br>
                2차 임원면접: 2024.11.06.(수) 17:00ㅣ각 면접장(취업정보센터 추후 공지)<br>
                최종합격자 발표: 2024.11.08.(금) 13:00ㅣGOE메신저(담임)으로 통보
                </p>
                <div class="apply-button-container">
                    <span class="apply-text">빅데이터정보과</span>
                </div>
