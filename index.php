    ...
    <section class="content">
        ...
        <div class="card-grid">
            ...
            <div class="card">
                ...
                <h2><br>봄헤어</h2>
                <p style="text-align: center;">뷰티아트과</p>
                <div class="apply-button-container">
                </div>
                <a href="https://hanbom.iwinv.kr/beauty.php" class="apply-button" id="applyBtn">채용공고 확인</a>
            </div>
            <!-- 1번 -->
            <div class="card">
                <div class="icon">
                ...
                <h2><br>Z랩 애니메이션</h2>
                <p style="text-align: center;">캐릭터창작과</p>
                <div class="apply-button-container">
                </div>
                <a href="https://hanbom.iwinv.kr/character.php" class="apply-button" id="applyBtn">채용공고 확인</a>
            </div>
            <!-- 1번 -->
            <div class="card">
                <div class="icon">
                ...
                <h2><br>(주)AtoZ</h2>
                <p style="text-align: center;">시각디자인과</p>
                <div class="apply-button-container">
                </div>
                <a href="https://hanbom.iwinv.kr/design.php" class="apply-button" id="applyBtn">채용공고 확인</a>
            </div>
            <!-- 1번 -->
            <div class="card">
                <div class="icon">
                ...
                <h2><br>(주)신통네트워크</h2>
                <p style="text-align: center;">빅데이터정보과</p>
                <div class="apply-button-container">
                </div>
                <a href="https://hanbom.iwinv.kr/bigdata.php" class="apply-button" id="applyBtn">채용공고 확인</a>
            </div>
            <!-- 1번 -->
            <div class="card">
                <div class="icon">
                ...
                <h2><br>(주)스마트테크</h2>
                <p style="text-align: center;">스마트제어과</p>
                <div class="apply-button-container">
                </div>
                <a href="https://hanbom.iwinv.kr/smart.php" class="apply-button" id="applyBtn">채용공고 확인</a>
            </div>
        </section>
    <footer>
