    ...
    <section class="content">
        ...
        <div class="card-grid">
            ...
            <div class="card">
                ...
                <p>회사명: 봄헤어ㅣ전화번호: 070-7860-7482ㅣFAX: 07078626710<br>주소: 경기도 수원시 권선구 호매실로ㅣ우편번호: 12345<br>대표자명: 이한봄ㅣ담당부장: 최미<br>주요생산품: 미용서비스ㅣ종업원수: 30명</p>
                <h3 style="text-align: left;">2. 채용현황</h3>
                <p>근무부서 모집직종: 헤어(헤어 미용사)<br>채용인원: 1명<br>자격조건: 특성화고(미용관련전공) 졸업(예정) 및 관련 자격증 보유자 우대, 모집직종과 관련된 다양한 활동(동아리, 단기근로, 체험 등) 유경험자, 해외여행에 결격사유가 없는 자</p>
                <h3 style="text-align: left;">3. 급여</h3>
                <p>근무시간: 09:00 ~ 18:00 (8시간)ㅣ근무형태: 주 5일 / 주당 40시간 근무<br>급여: 연봉 2,400만원ㅣ상여금: 1년 근속 400%<br>기타: 문화생활비(10만원), 중식비 제공, 근무성과 우수자 인센티브 지급</p>
                ...
                <div class="apply-button-container">
                    <span class="apply-text">뷰티아트과</span>
                </div>
