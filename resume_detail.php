...
<script>
// PHP에서 가져온 정보를 JavaScript 변수로 전달
var u_name = "<?php echo $u_name; ?>";
var u_g = "<?php echo $u_g; ?>";
var u_c = "<?php echo $u_c; ?>";
var u_num = "<?php echo $u_num; ?>";
var u_dp = "<?php echo $u_dp; ?>";
</script>
<script>
document.getElementById('download-png').addEventListener('click', function() {
    // 연락사항에서 성명 필드에 입력된 이름 가져오기
    var contactName = document.querySelector('.field-value').innerText;  // 예: 성명 부분이 .field-value 클래스인 경우
    ...
    html2canvas(document.getElementById('resume-content'), {
        ...
        // 학년, 반, 번호를 포함한 파일명 설정 (성명은 연락사항에서 가져온 이름 사용)
        imageLink.download = contactName + '_입사지원서.png';
